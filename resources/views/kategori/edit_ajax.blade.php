    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data Kategori (AJAX)</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $kategori->kategori_nama }}" type="text" name="m_kategori" id="kategori_nama" class="form-control" required>
