<form action="{{ url('/kategori/ajax') }}" method="POST" id="form-create-kategori">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Kategori (AJAX)</h5>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.status){
                            ...
                            tableKategori.ajax.reload(); // Memanggil reload data tableKategori
                        } else {
                            $('.error-text').text('');
