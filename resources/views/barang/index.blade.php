...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a href="{{ url('/barang/export_excel') }}" class="btn btn-primary"><i class="fas fa-file-excel"></i> Export Excel</a>
            <a href="{{ url('/barang/export_pdf') }}" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export Barang</a>
