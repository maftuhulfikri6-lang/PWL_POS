        ...
        @else
            <form method="POST" action="{{ url('/barang/'.$barang->barang_id) }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-1 control-label">Kategori</label>
                    <div class="col-11">
                ...
                <div class="form-group row">
                    <label class="col-1 control-label">Kode Barang</label>
                    <div class="col-11">
                        <input type="text" class="form-control" name="barang_kode" 
                               value="{{ old('barang_kode', $barang->barang_kode) }}" required>
                        @error('barang_kode') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-1 control-label">Nama Barang</label>
                    <div class="col-11">
                        <input type="text" class="form-control" name="barang_nama" 
                               value="{{ old('barang_nama', $barang->barang_nama) }}" required>
                        @error('barang_nama') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-1 control-label">Harga Beli</label>
                    <div class="col-11">
                ...
                <div class="form-group row">
                    <label class="col-1 control-label">Harga Jual</label>
                    <div class="col-11">
