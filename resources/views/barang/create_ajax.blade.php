<form action="{{ url('/barang/ajax') }}" method="POST" id="form-create-barang">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Barang (AJAX)</h5>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.status){
                            ...
                            tableBarang.ajax.reload(); // Memanggil reload data tableBarang global
                        } else {
                            $('.error-text').text('');
